...
const ruleProviders = {
  ...
  "Spotify": { ...ruleProviderCommon, "url": "https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/refs/heads/master/rule/Clash/Spotify/Spotify.yaml", "path": "./ruleset/spotify.yaml" },
};

const rules = [
  "RULE-SET,myreject,AdBlock",
...
function main(params) {
  ...
  const groups = [
    ...
    { "name": "Emby节点", "type": "select", "proxies": ["DIRECT", "代理", "低倍率节点", "香港节点", "日本节点", "台湾节点", "美国节点", "新加坡节点"], "include-all": true, "filter": "0\.[0-9]+", "icon": "https://raw.githubusercontent.com/Orz-3/mini/master/Color/Emby.png" },
    ...
    { "name": "低倍率节点", "type": "url-test", "include-all": true, ...groupBase, "filter": "低|0\.[0-9]+", "icon":"https://img.icons8.com/?size=100&id=14108&format=png&color=000000"},
  ]
